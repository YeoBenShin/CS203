    ...
    <nav className="w-full bg-white shadow-md border-b border-gray-200 p-6 flex items-center justify-between">
      ...
      <ul className="flex space-x-6 text-sm font-medium">
        ...
        >
          ...
          >
            <Link href="/admin" className="block px-4 py-2 text-black hover:bg-blue-100">Admin Home</Link>
            <Link href="/admin/countries" className="block px-4 py-2 text-black hover:bg-blue-100">Manage Countries</Link>
            <Link href="/admin/products" className="block px-4 py-2 text-black hover:bg-blue-100">Manage Products</Link>
            <Link href="/admin/mapping" className="block px-4 py-2 text-black hover:bg-blue-100">Create Mapping</Link>
            <Link href="/admin/tariff" className="block px-4 py-2 text-black hover:bg-blue-100">Add Tariff</Link>
          </div>
        </li>
        <li>
